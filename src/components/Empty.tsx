import s from "../DropContainer/DropContainer.module.css";

const Empty = () => {
  return (
    <div className={s.build_zone_message}>
      <svg
        width="22"
        height="22"
        viewBox="0 0 22 22"
      ...
      <span className={s.build_zone_message_heading}>Перетащите сюда</span>
      <span className={s.build_zone_message_text}>
        любой элемент
        <br />
        из левой панели
      </span>
